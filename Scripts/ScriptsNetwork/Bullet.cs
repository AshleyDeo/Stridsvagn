...
//    private int lastObjectReflected;
...
//        {
//            if ((reflector.collider.tag == "EnemyShield") || (reflector.collider.tag == "FriendlyShield"))
//            {
//                int reflected = reflector.collider.gameObject.GetInstanceID(); ;
//                if (reflected != lastObjectReflected)
//                {
//                    lastObjectReflected = reflected;
//                    calculateReflection(reflector);
//                }
//            }
//        }
//    }
