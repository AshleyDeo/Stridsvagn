	...
	public class RebindControls : MonoBehaviour {
		...
		protected void OnEnable() {
			if (s_RebindActionUIs == null)
				s_RebindActionUIs = new List<RebindControls>();
		...
		private static List<RebindControls> s_RebindActionUIs;
		...
		[Serializable]
		public class UpdateBindingUIEvent : UnityEvent<RebindControls, string, string, string> {
		}

		[Serializable]
		public class InteractiveRebindEvent : UnityEvent<RebindControls, InputActionRebindingExtensions.RebindingOperation> {
		}
	}
}